...
This project uses a anonymized Kaggle dataset of credit card 
transactions made by European cardholders to 
identify fraudulent and non - fraudulent transactions. 
The models used include Logistic Regression, Decision Tree, Random Forest, and XGBoost.'''
